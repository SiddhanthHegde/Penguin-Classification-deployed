...
def predict():
    ...
    if pred == 0:
        ...
        img = '../static/Adelie Penguins.jpg'
    if pred == 1:
        ...
        img = '../static/Chinstrap Penguin.jpg'
    if pred == 2:
        ...
        img = '../static/gentoo-penguins.jpg'

    return render_template('output.html', prediction_text=output_text, img_path=img,description=desc)
